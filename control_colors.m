...
h = [handles.pushbutton_update_calibration_files...
    handles.pushbutton_unknown_file handles.pushbutton_decrement...
    handles.pushbutton_increment handles.pushbutton_live...
    handles.pushbutton_process handles.pushbutton_rotate...
    handles.pushbutton_clear_figures handles.pushbutton_quit...
    handles.pushbutton_update_hardware_parameters...
    handles.edit_wavelength_min_left handles.edit_wavelength_max_left...
    handles.edit_ROI_min_left handles.edit_ROI_max_left...
    handles.edit_wavelength_min_right handles.edit_wavelength_max_right...
    handles.edit_ROI_min_right handles.edit_ROI_max_right];
