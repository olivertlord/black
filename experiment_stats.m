function experiment_stats(filepath)
    ...
    combined_column_header = sprintf('%-35s%-10s%-10s%-10s%-10s%-10s%-10s%-10s', ...
        ' ', 'Duration', 'Max', 'E Max', 'Min', 'E Min', 'Mean', 'E Mean');
    stats_line = sprintf('%-35s%-10d%-10d%-10d%-10d%-10d%-10d%-10d', ...
        ' ', round(duration), round(stats(2)), round(stats(3)), ...
        round(stats(4)), round(stats(5)), ...
        round(stats(6)), round(stats(7)));
