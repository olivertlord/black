...
microns_l = linspace(-(mxrowl - mnrowl + 2 / 2) * 0.52, (mxrowl - mnrowl + 2 / 2) * 0.52, mxrowl - mnrowl + 1);
microns_r = linspace(-(mxrowr - mnrowr + 2 / 2) * 0.52, (mxrowr - mnrowr + 2 / 2) * 0.52, mxrowr - mnrowr + 1);
