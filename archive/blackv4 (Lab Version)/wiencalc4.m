...
if (spec == 1);
    [fid,message]=fopen('/Applications/MATLAB/blackv4/E256.dat');
...
elseif (spec == 2);
    [fid,message]=fopen('/Applications/MATLAB/blackv4/E128.dat');
    for i=1:58; E(i) = fscanf(fid,'%f6.3') ; end;
    for i=1:58; lam(i)=430+i*10;end;
    for i=1:col; w(i) = conp + pix1*i - pix2*i^2;end;
    [lamp]= lampcal(w,lam,E);
elseif (spec == 4);
    [fid,message]=fopen('/Applications/MATLAB/blackv4/E100.dat');
